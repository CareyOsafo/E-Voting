                    ...
                    while($row = $query->fetch_assoc()){
                      echo "
                        <tr>
                          ...
                          <td>".$row['votname']."</td>
                          <td>".date("M d, Y  @ h:i a", strtotime($row['datetime_voted']))."</td>
                        </tr>
                      ";
                    }
                  ?>
