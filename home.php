				    ...
				    <?php
				    	...
				    	if($vquery->num_rows > 0){
				    		...
				    		<div class="text-center">
					    		<h3>Thank you for voting your favorite candidate!</h3>
							...
							<!-- Quering db to get election status -->
							<?php
							$query = "SELECT * FROM election_settings";
                                              $result = $conn->query($query);
                                              while ($row_es= $result->fetch_assoc()) {
                                               $status = $row_es['election_status'];
											  }
                                              ?>
							<!-- Show election -->
                            <?php 
						   ...
						   echo ' <form method="POST" id="ballotForm" action="submit_ballot.php">';
							}
							elseif ($status=="GettingReady"){

							echo '<h2 class="text-center">Keep calm! voting starts in a few minutes</h2>';
							echo ' <form method="POST" id="ballotForm" action="submit_ballot.php" hidden>';
							
								 }

							elseif ($status=="Close"){
								echo '<h1 style="color:red" class="text-center">Sorry this voting session has been closed.</h2>';
								echo '<h3 class="text-center">Election results will be publish soon...</h3>';
								echo ' <form method="POST" id="ballotForm" action="submit_ballot.php" hidden>';
										 }
